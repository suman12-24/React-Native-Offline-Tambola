            ...
            <View style={{ height: windowHeight * .90 }}>
                {
                    gameData?.playerInfo?.reduce((sum, player) => sum + player?.tickets.length, 0) != 0 ?
                        ...
                        <View style={{ height: windowHeight * .2, backgroundColor: '#fff', height: '22%' }}>
                        ...
                        :
                        <View style={{ height: 150, backgroundColor: '#fff', height: '22%' }}>
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    ...
                                    <TextInput
                                        style={{
                                            ...
                                            paddingHorizontal: 10,
                                            fontSize: 26,
                                            lineHeight: 45, // Increases the line height, making the cursor appear taller
                                        }}
